...
$routes->group('', ['filter' => 'auth'], function($routes) {
    ...
    $routes->group('avaliacoes', function($routes) {
        ...
        $routes->get('avaliar-dia/(:segment)', 'Avaliacoes::avaliarDia/$1');
        $routes->post('salvar-avaliacao-dia', 'Avaliacoes::salvarAvaliacaoDia');
    ...
    // Avaliação de Colaboradora (Cliente)
    $routes->group('avaliacao-colaboradora-cliente', function($routes) {
        // Cliente
        $routes->get('/', 'AvaliacaoColaboradoraCliente::index');
        $routes->post('salvar', 'AvaliacaoColaboradoraCliente::salvar');
        $routes->get('obrigado', 'AvaliacaoColaboradoraCliente::obrigado');
        $routes->get('historico', 'AvaliacaoColaboradoraCliente::historico');

        // Dashboard (Admin/Atendente)
        $routes->get('dashboard', 'AvaliacaoColaboradoraCliente::dashboard', ['filter' => 'staff']);
    });
