            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0"><?= $contagem_status['aberto'] + $contagem_status['em_atendimento'] ?? 0 ?></h2>
                    </div>
...
new Chart(ctxStatus, {
    ...
    data: {
        ...
        datasets: [{
            data: [
                <?= $contagem_status['aberto'] ?>,
                <?= $contagem_status['em_atendimento'] ?>,
                <?= $contagem_status['aguardando_cliente'] ?>,
                <?= $contagem_status['finalizado'] ?>
            ],
...
new Chart(ctxTipo, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Quantidade',
            data: [
                <?= $contagem_tipo['ocorrencia'] ?>,
                <?= $contagem_tipo['solicitacao'] ?>
            ],
