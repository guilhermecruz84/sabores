        ...
        <div class="row">
            ...
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= (strpos(uri_string(), 'operacional/cmv') !== false) ? 'active' : '' ?>"
                           href="<?= base_url('operacional/cmv') ?>">
            ...
            <!-- Main Content -->
            <main class="<?= (isset($usuarioLogado) && $usuarioLogado->tipo === 'admin') ? 'col-md-10' : 'col-12' ?> ms-sm-auto px-md-4">
            <!-- Mensagens Flash -->
