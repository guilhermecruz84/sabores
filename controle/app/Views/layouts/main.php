            ...
            <nav class="col-md-2 sidebar px-0" id="sidebar">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= strpos(uri_string(), 'avaliacoes') !== false ? 'active' : '' ?>" href="<?= base_url('avaliacoes') ?>">
                        ...
                        <?php if ($usuarioLogado->tipo === 'admin' || $usuarioLogado->tipo === 'atendente'): ?>
                        <li class="nav-item">
                            <a class="nav-link <?= strpos(uri_string(), 'avaliacoes') !== false ? 'active' : '' ?>" href="<?= base_url('avaliacoes/dashboard') ?>">
                                <i class="fas fa-star"></i>
                                Avaliações
                            </a>
                        </li>
